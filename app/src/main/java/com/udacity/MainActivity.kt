...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        custom_button.setOnClickListener {
            if (this::selectedDownloadUrl.isInitialized) {
    ...
    private fun download() {
        val request =
            DownloadManager.Request(Uri.parse(selectedDownloadUrl.uri))
    ...
    private fun createNotification() {
        ...
        detailIntent.putExtra("fileName", selectedDownloadUrl.title)
        ...
        val builder = NotificationCompat.Builder(applicationContext, CHANNEL_ID)
            ...
            .setContentTitle(selectedDownloadUrl.title)
            .setContentText(selectedDownloadUrl.text)
